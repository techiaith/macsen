...
Client code for the Jasper voice computing platform (based on the Jasper platform). Macsen is an open source platform for developing always-on, multilingual, voice-controlled applications.
